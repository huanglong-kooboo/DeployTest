...
set _DeploySetParametersFile=%RootPath%MvcApplication1.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%MvcApplication1.zip" (
echo "%RootPath%MvcApplication1.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MvcApplication1.zip',EncryptPassword='Encryption password is used only if any deployment setting is marked as secure' -dest:%_Destination%,EncryptPassword='Encryption password is used only if any deployment setting is marked as secure' -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MvcApplication1.zip',EncryptPassword='Encryption password is used only if any deployment setting is marked as secure' -dest:%_Destination%,EncryptPassword='Encryption password is used only if any deployment setting is marked as secure' -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%MvcApplication1.deploy-readme.txt" (
...
start notepad "%RootPath%MvcApplication1.deploy-readme.txt"
)
echo =========================================================
goto :eof
